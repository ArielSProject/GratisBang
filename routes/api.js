...
router.get('/randomgambar/couplepp', async (req, res, next) => {
	...
	let resultt = await fetchJson('https://raw.githubusercontent.com/iamriz7/kopel_/main/kopel.json')
...
router.get('/randomgambar/dadu', async (req, res, next) => {
	...
	let dadu = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/dadu.json')
...
router.get('/game/susunkata', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/susunkata.json')
...
router.get('/game/tembakbendera', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/tebakbendera.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tembakgame', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/tebakgame.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tembakkata', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/tebakkata.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tembaklirik', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/tebaklirik.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tembaklagu', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/tebaklagu.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
...
router.get('/game/tembakkimia', async (req, res, next) => {
	...
	let ra = await fetchJson('https://raw.githubusercontent.com/ArielSProject/Data-AespiAPIs/main/tebakkimia.json')
	let ha = ra[Math.floor(Math.random() * ra.length)]
